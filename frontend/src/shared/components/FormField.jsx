...
const baseInput =
  'w-full px-4 py-2.5 rounded-lg border bg-paper-50 dark:bg-[#2A241F] text-surface-900 dark:text-paper-50 placeholder-surface-400 dark:placeholder-surface-500 transition-all duration-200 focus:outline-none focus:ring-2 focus:ring-surface-400/50 focus:border-surface-400 shadow-sm font-body';

const normalBorder = 'border-surface-300 dark:border-[#5D5246]';
